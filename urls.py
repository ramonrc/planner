...
urlpatterns = patterns('',
    ...
    url(r'^persona/', 'captura.views.pers'),
    url(r'^problema/add/(?P<pid>\d+)/(?P<elem>.*)/', 'captura.views.addpr'),
    url(r'^problema/edit/(?P<pro_id>\d+)/(?P<elem>.*)/(?P<a_id>\d+)/', 'captura.views.editpr'),
#    url(r'^comentario/add/(?P<pid>\d+)/', 'captura.views.addc'),
#    url(r'^comentario/edit/(?P<co_id>\d+)/', 'captura.views.editc'),
